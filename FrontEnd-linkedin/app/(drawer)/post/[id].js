...
import usePostFetchById from "../../../hooks/usePostFetchById";
...
const Id = () => {
  ...
  const onComment = async () => {
    const result = await addCommentonPost(text, user?.id);
    if (result) {
      console.log("ok");
    } else {
      console.log("notok");
  ...
  return (
    <ScrollView
      refreshControl={
        <RefreshControl refreshing={loading} onRefresh={refetchPost} />
      }
    >
      <PostCard
        item={post}
